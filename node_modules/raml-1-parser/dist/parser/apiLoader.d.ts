...
export declare function load(ramlPath: string, options?: parserCoreApi.Options2): Promise<Object>;
export declare function loadSync(ramlPath: string, options?: parserCoreApi.Options2): Object;
/***
