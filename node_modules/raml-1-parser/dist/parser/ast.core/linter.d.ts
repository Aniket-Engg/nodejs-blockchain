...
export declare function createIssue(issueCode: string, message: string, node: hl.IParseResult, isWarning?: boolean, internalRange?: def.rt.tsInterfaces.RangeObject, forceScalar?: boolean): hl.ValidationIssue;
