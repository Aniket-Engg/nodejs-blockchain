...
function testAPILibExpandNewFormat(apiPath, extensions, tckJsonPath) {
    doTestAPI(apiPath, extensions, tckJsonPath, true, false, true, true, true);
}
...
function testAPIScript(o) {
    return doTestAPI(o.apiPath, o.extensions, o.tckJsonPath, o.newFormat, o.regenerteJSON, true, true, o.expandLib, o.unfoldTypes, o.serializeMetadata);
}
...
function doTestAPI(apiPath, extensions, tckJsonPath, newFormat, regenerteJSON, callTests, doAssert, expandLib, unfoldTypes, serializeMetadata) {
    if (newFormat === void 0) { newFormat = false; }
    if (regenerteJSON === void 0) { regenerteJSON = false; }
    if (callTests === void 0) { callTests = true; }
    if (doAssert === void 0) { doAssert = true; }
    if (expandLib === void 0) { expandLib = false; }
    if (unfoldTypes === void 0) { unfoldTypes = false; }
...
function generateMochaSuite(folderAbsPath, dstPath, dataRoot, mochaSuiteTitle, libExpand, newFormat, unfoldTypes) {
    if (libExpand === void 0) { libExpand = false; }
    if (newFormat === void 0) { newFormat = false; }
    if (unfoldTypes === void 0) { unfoldTypes = false; }
    var dirs = iterateFolder(folderAbsPath);
    var map = {};
...
function dumpSuite(title, dataRoot, tests, libExpand, newFormat, unfoldTypes) {
    var dumpedTests = tests.map(function (x) { return dumpTest(x, dataRoot, libExpand, newFormat, unfoldTypes); });
    var testsStr = dumpedTests.join("\n\n");
    return "describe('" + title + "',function(){\n    \n" + testsStr + "\n    \n});";
}
function dumpTest(test, dataRoot, libExpand, newFormat, unfoldTypes) {
