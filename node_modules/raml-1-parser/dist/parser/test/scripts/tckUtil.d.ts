...
export declare function testAPILibExpandNewFormat(apiPath: string, extensions?: string[], tckJsonPath?: string): void;
...
export declare function generateMochaSuite(folderAbsPath: string, dstPath: string, dataRoot: string, mochaSuiteTitle: string, libExpand?: boolean, newFormat?: boolean, unfoldTypes?: boolean): void;
