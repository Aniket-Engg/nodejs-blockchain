...
tckUtil.generateMochaSuite(path.resolve(tckUtil.projectFolder(), "src/parser/test/data/TCK-newFormat"), path.resolve(tckUtil.projectFolder(), "src/parser/test/TCK2-newFormat.ts"), dataRoot, 'Complete TCK Test Set For New JSON Format', false, true);
tckUtil.generateMochaSuite(path.resolve(tckUtil.projectFolder(), "src/parser/test/data/LibraryExpansion-newFormat"), path.resolve(tckUtil.projectFolder(), "src/parser/test/libraryExpansion-newFormat.ts"), dataRoot, 'Library Expansion Tests For NEW JSON Format', true, true);
tckUtil.generateMochaSuite(path.resolve(tckUtil.projectFolder(), "src/parser/test/data/parser/UnfoldTypes"), path.resolve(tckUtil.projectFolder(), "src/parser/test/unfoldTypes.ts"), dataRoot, 'Types Unfolding Tests', false, true, true);
